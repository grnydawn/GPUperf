...
contains
  ...
  subroutine semi_discrete_step( state_init , state_forcing , state_out , dt , dir , flux , tend )
    ...
    !$acc parallel loop present(state_init, tend)
    do ll = 1 , NUM_VARS
      do k = 1 , nz
        do i = 1 , nx
  ...
  subroutine compute_tendencies_x(state,flux,tend)
    ...
    !$acc parallel loop present(tend, flux)
    do ll = 1 , NUM_VARS
      do k = 1 , nz
        do i = 1 , nx
  ...
  subroutine compute_tendencies_z(state,flux,tend)
    ...
    !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    !Use the fluxes to compute tendencies for each cell
    !$acc parallel loop present(tend, state, flux)
    do ll = 1 , NUM_VARS
      do k = 1 , nz
        do i = 1 , nx
  ...
  subroutine reductions( mass , te )
    ...
    !$acc parallel loop reduction(+:mass,te) present(hy_dens_cell, &
